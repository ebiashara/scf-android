class TaskByIdResponseMessage {
  String status;
  String statusCode;
  String message;
  Null responseException;
  List<TaskDets> result;

  TaskByIdResponseMessage(
      {this.status,
      this.statusCode,
      this.message,
  ...
  TaskByIdResponseMessage.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    statusCode = json['statusCode'];
    message = json['message'];
    responseException = json['responseException'];
    if (json['result'] != null) {
      result = new List<TaskDets>();
      json['result'].forEach((v) {
        result.add(new TaskDets.fromJson(v));
      });
    }
  }
...
class TaskDets {
  ...
  TaskDets.fromJson(Map<String, dynamic> json) {
    idfrid = json['idfrid'];
